...
class Problem(models.Model):
    ...
    submission_regex = models.CharField(max_length=1024,null=True,blank=True,default=".*")
    created_date = models.DateTimeField(default=timezone.now)
    updated_date = models.DateTimeField(default=timezone.now)
    sharing = models.BooleanField(default=False,blank=True)
    allowed_languages = models.CharField(max_length=1024,blank=True,default="")
    pdf_url = models.CharField(max_length=256,null=True,blank=True,default=None)
...
class Collection(models.Model):
    ...
    description = models.CharField(max_length=8192,null=True,blank=True,default=None)
    is_active = models.BooleanField(default=True,blank=True)
    is_private = models.BooleanField(default=False,blank=True)
    created_date = models.DateTimeField(default=timezone.now)
    updated_date = models.DateTimeField(default=timezone.now)
...
class Topic(models.Model):
    ...
    name = models.CharField(max_length=128)
    description = models.CharField(max_length=8192,null=True,blank=True,default=None)
    image_url = models.CharField(max_length=256,null=True,blank=True,default=None)
    is_active = models.BooleanField(default=True,blank=True)
    is_private = models.BooleanField(default=False,blank=True)
    created_date = models.DateTimeField(default=timezone.now)
    updated_date = models.DateTimeField(default=timezone.now)
